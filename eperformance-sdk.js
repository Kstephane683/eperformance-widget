...
`,p=`<svg width="26" height="26" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 3C6.9 3 2.8 6.6 2.8 11c0 2.1 0.9 4 2.4 5.4-0.2 1.2-0.8 2.4-1.7 3.2-0.3 0.3 0 0.8 0.4 0.7 1.9-0.3 3.5-1 4.6-1.8 1.1 0.4 2.3 0.6 3.5 0.6 5.1 0 9.2-3.6 9.2-8S17.1 3 12 3z" fill="currentColor"/></svg>`,m=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"/></svg>`,h={...t},g=!1,_=null,v=null,y={open:[],close:[]};function b(e){var t;let r=document.getElementById(i);r==null||(t=r.contentWindow)==null||t.postMessage(`${n}${JSON.stringify(e)}`,`*`)}function x(e){if(typeof e.data==`string`&&e.data.startsWith(n))try{let t=JSON.parse(e.data.slice(20));t.event===`close`&&g&&A(),t.event===`ready`&&b({event:g?`open`:`close`}),t.event===`input-focus`&&g&&(_==null||_(),v==null||v())}catch{}}var S=`eperf-theme`;function C(){if(h.theme===`light`||h.theme===`dark`)return h.theme;let e=document.documentElement.getAttribute(`data-theme`);if(e===`dark`||e===`light`)return e;try{let e=localStorage.getItem(S);if(e===`dark`||e===`light`)return e}catch{}return`light`}function w(){let e=()=>b({event:`theme`,theme:C()});new MutationObserver(e).observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`]}),window.addEventListener(`storage`,t=>{t.key===S&&e()})}function T(){let e=new URL(h.widgetUrl,window.location.href);return e.searchParams.set(`apiUrl`,h.apiUrl),e.searchParams.set(`siteId`,h.siteId),e.searchParams.set(`color`,h.color),e.searchParams.set(`theme`,C()),e.toString()}function E(){if(document.getElementById(i))return;let e=document.createElement(`div`);e.id=a,e.className=`ep-holder--${h.position}`,e.setAttribute(`aria-hidden`,`true`);let t=document.createElement(`iframe`);t.id=i,t.src=T(),t.title=`Assistant ePerformance`,t.allow=`clipboard-write`,e.appendChild(t),document.body.appendChild(e)}function D(){if(document.getElementById(o))return;let e=document.createElement(`button`);e.id=o,e.type=`button`,e.className=`ep-bubble--${h.position}`,e.setAttribute(`aria-label`,`Ouvrir le chat`),e.style.background=`linear-gradient(135deg, ${h.color} 0%, #e2c07a 100%)`,e.innerHTML=p,e.addEventListener(`click`,j),document.body.appendChild(e)}function O(e){let t=document.getElementById(o);t&&(t.innerHTML=e)}function k(){var e,t,n;g||(g=!0,F(),sessionStorage.setItem(c,`1`),(e=document.getElementById(a))==null||e.classList.add(`ep-holder--visible`),(t=document.getElementById(a))==null||t.removeAttribute(`aria-hidden`),(n=document.getElementById(o))==null||n.classList.add(`ep-bubble--open`),O(m),b({event:`open`,theme:C()}),_==null||_(),y.open.forEach(e=>e()))}function A(){var e,t,n;g&&(g=!1,sessionStorage.removeItem(c),(e=document.getElementById(a))==null||e.classList.remove(`ep-holder--visible`),(t=document.getElementById(a))==null||t.setAttribute(`aria-hidden`,`true`),(n=document.getElementById(o))==null||n.classList.remove(`ep-bubble--open`),O(p),b({event:`close`}),y.close.forEach(e=>e()))}function j(){g?A():k()}function M(){let e=window.visualViewport;if(!e)return;let t=()=>{let t=document.getElementById(a);t&&g&&window.matchMedia(`(max-width: ${u}px)`).matches&&(window.innerHeight-e.height>150||e.offsetTop>4?(t.style.setProperty(`top`,`${Math.round(e.offsetTop)}px`,`important`),t.style.setProperty(`height`,`${Math.round(e.height)}px`,`important`),t.style.setProperty(`bottom`,`auto`,`important`)):(t.style.removeProperty(`top`),t.style.removeProperty(`height`),t.style.removeProperty(`bottom`)))};e.addEventListener(`resize`,t),e.addEventListener(`scroll`,t),window.addEventListener(`resize`,t);let n=()=>{setTimeout(t,350),setTimeout(t,800)};e.addEventListener(`resize`,n),_=t,v=n}function N(){let e=document.createElement(`style`);e.textContent=f,document.head.appendChild(e)}function P(){window.ePerformance={open:k,close:A,toggle:j,identify:(e,t={})=>b({event:`identify`,userId:e,userData:t}),on:(e,t)=>{(e===`open`||e===`close`)&&y[e].push(t)}}}function F(){var e;sessionStorage.setItem(l,`1`),(e=document.getElementById(s))==null||e.remove()}function I(){sessionStorage.getItem(l)||setTimeout(()=>{if(g||sessionStorage.getItem(l))return;let e=document.createElement(`div`);e.id=s,e.setAttribute(`role`,`button`),e.setAttribute(`tabindex`,`0`),e.innerHTML=`<span>Une question sur votre business ?</span><button type="button" aria-label="Masquer">✕</button>`,e.addEventListener(`click`,e=>{e.target.tagName===`BUTTON`?F():k()}),document.body.appendChild(e),sessionStorage.setItem(l,`1`),requestAnimationFrame(()=>e.classList.add(`ep-teaser--visible`))},d)}function L(){window.addEventListener(`keydown`,e=>{e.key===`Escape`&&g&&A()})}function R(){h={...t,...window.ePerformanceConfig},N(),E(),D(),window.addEventListener(`message`,x),M(),L(),w(),P(),sessionStorage.getItem(c)===`1`?k():I()}return document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,R,{once:!0}):R(),e.initSdk=R,e})({});